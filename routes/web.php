...
Route::group(['prefix'=>'admin'],   function() {
	...
	Route::post('/article/update','Admin\ArticleController@update')->where('id','[0-9]+')->name('adminArticleUpdate');
	...
	Route::post('/tag/update','Admin\TagController@update')->where('id','[0-9]+')->name('adminTagUpdate');
	...
	Route::post('/category/update', 'Admin\CategoryController@update')->where('id','[0-9]+')->name('adminCategoryUpdate');
